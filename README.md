...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Header** | Marshal | 345 ns / 4 allocs | 303 ns / 4 allocs | 167 ns / 3 allocs | 1.8× |
| **Header** | Unmarshal | 348 ns / 4 allocs | 300 ns / 4 allocs | 121 ns / 2 allocs | 2.5× |
| **IntSlice** | Marshal | 5,590 ns / 6 allocs | 6,270 ns / 6 allocs | 6,136 ns / 5 allocs | 1.0× |
| **IntSlice** | Unmarshal | 7,675 ns / 6 allocs | 7,061 ns / 6 allocs | 6,656 ns / 4 allocs | 1.1× |
| **Record** | Marshal | 651 ns / 7 allocs | 637 ns / 7 allocs | 356 ns / 6 allocs | 1.8× |
| **Record** | Unmarshal | 579 ns / 7 allocs | 581 ns / 7 allocs | 382 ns / 6 allocs | 1.5× |
| **Nested** | Marshal | 3,174 ns / 71 allocs | 3,184 ns / 71 allocs | 2,986 ns / 70 allocs | 1.1× |
| **Nested** | Unmarshal | 3,209 ns / 69 allocs | 2,980 ns / 69 allocs | 2,782 ns / 67 allocs | 1.1× |
